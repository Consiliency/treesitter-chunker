...
plugin_files = [
    Path('/home/jenner/code/treesitter-chunker-worktrees/metadata-extraction/chunker/languages/go_plugin.py'),
    Path('/home/jenner/code/treesitter-chunker-worktrees/metadata-extraction/chunker/languages/java_plugin.py'),
    Path('/home/jenner/code/treesitter-chunker-worktrees/metadata-extraction/chunker/languages/ruby_plugin.py'),
]
