...
'''
        ...
        print("\nKey functions:")
        lines = stats.split('\n')
        relevant_keywords = ['process_batch', 'process_file', 'chunk', 'parse', 'thread']
...
def profile_memory_usage():
    ...
    try:
        ...
        print(f"   After second run (cached):")
...
def profile_incremental_parsing():
    ...
    try:
        ...
        new_content = content.replace("def complex_function_50", "def modified_function_50")
        ...
        lines = stats.split('\n')
        incremental_keywords = ['incremental', 'detect_changes', 'parse_incremental', 'update_chunks']
