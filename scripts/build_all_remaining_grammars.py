    ...
    try:
        ...
        if builder.build_individual(language):
            ...
            if build_file.exists():
                ...
                return (language, True, f"Successfully built and moved to {package_file}")
        ...
        return (language, False, f"Exception: {str(e)}")
...
def main():
    ...
    all_languages = {
        "c", "clojure", "cpp", "csharp", "css", "dart", "dockerfile", 
        "elixir", "go", "haskell", "html", "java", "javascript", "json",
        "julia", "kotlin", "matlab", "nasm", "ocaml", "php", "python",
        "r", "ruby", "rust", "scala", "sql", "svelte", "swift", "toml",
        "typescript", "vue", "wasm", "xml", "yaml", "zig"
    }
    ...
    categories = {
        ...
        "Functional & Academic": ["haskell", "ocaml", "scala", "elixir", "clojure", "julia"],
        "Specialized & Domain": ["matlab", "r", "sql", "nasm", "css", "html", "json", "toml", "yaml", "xml"],
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as executor:
        ...
        futures = {executor.submit(build_grammar, lang): lang 
