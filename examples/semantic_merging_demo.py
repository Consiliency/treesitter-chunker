...
from chunker import CodeChunk, get_parser
...
def demonstrate_relationship_analysis(chunks):
    ...
    methods = [c for c in chunks if c.node_type in ["function_definition", "method_definition"]]
...
def demonstrate_semantic_merging(chunks):
    ...
    for chunk in merged_chunks:
        if chunk.node_type in ["function_definition", "method_definition", "merged_chunk"]:
...
def demonstrate_configuration_impact():
    ...
    method_chunks = [c for c in chunks if c.node_type in ["function_definition", "method_definition"]]
