...
def demonstrate_diff_computation():
    ...
    from chunker.interfaces.incremental import ChunkDiff, ChunkChange
    ...
    diff = ChunkDiff(
        ...
        deleted_chunks=[],
        modified_chunks=[(old_chunks[0], new_chunks[0]), (old_chunks[1], new_chunks[1])],
        unchanged_chunks=[],
        summary={
            'total_old_chunks': 2,
            'total_new_chunks': 3,
...
def demonstrate_move_detection():
    ...
    if moved:
        ...
        for old, new in moved:
            ...
            print(f"    Similarity: Very High (same content)")
    else:
