...
""")
    ...
    with tempfile.NamedTemporaryFile(mode='w', suffix='.md', delete=False) as f:
        f.write("""# Fallback Chunking Demo
...
""")
    ...
    with tempfile.NamedTemporaryFile(mode='w', suffix='.csv', delete=False) as f:
        f.write("""timestamp,level,message,user_id
...
def demo_specialized_chunking(sample_files):
    ...
    with open(sample_files['log']) as f:
        log_content = f.read()
    ...
    with open(sample_files['markdown']) as f:
        md_content = f.read()
    ...
    with open(sample_files['csv']) as f:
        csv_content = f.read()
...
def main():
    ...
    try:
        ...
        print("\n\n✅ Demo complete!")
        print("\nKey takeaways:")
        print("1. Fallback chunking always emits warnings to encourage Tree-sitter usage")
