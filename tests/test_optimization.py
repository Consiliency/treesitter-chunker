...
class TestChunkOptimizer:
    ...
    def test_optimize_for_llm_balanced(self, optimizer, sample_chunks, mock_token_counter):
    ...
    def test_optimize_for_llm_aggressive(self, optimizer, sample_chunks, mock_token_counter):
    ...
    def test_optimize_for_llm_conservative(self, optimizer, sample_chunks, mock_token_counter):
    ...
    def test_optimize_for_llm_preserve_structure(self, optimizer, sample_chunks, mock_token_counter):
    ...
    def test_merge_small_chunks(self, optimizer, mock_token_counter):
        ...
        mock_token_counter.count_tokens.side_effect = lambda text, model="gpt-4": 5  # Small token count
    ...
    def test_merge_small_chunks_preserve_boundaries(self, optimizer, mock_token_counter):
        ...
        merged = optimizer.merge_small_chunks(chunks, min_tokens=20, preserve_boundaries=True)
    ...
    def test_split_large_chunks(self, optimizer, mock_token_counter):
        ...
        with patch.object(optimizer.boundary_analyzer, 'find_natural_boundaries') as mock_boundaries:
    ...
    def test_rebalance_chunks(self, optimizer, sample_chunks, mock_token_counter):
        ...
        rebalanced = optimizer.rebalance_chunks(sample_chunks, target_tokens=50, variance=0.2)
    ...
    def test_coherence_score_calculation(self, optimizer, mock_token_counter):
        ...
        _, metrics = optimizer.optimize_for_llm(
            chunks, "gpt-4", 100, OptimizationStrategy.CONSERVATIVE
        )
...
class TestOptimizationIntegration:
    ...
    def test_optimization_preserves_chunk_integrity(self, real_optimizer):
        ...
        optimized, _ = real_optimizer.optimize_for_llm(
            chunks, "gpt-4", 1000, OptimizationStrategy.CONSERVATIVE
        )
    ...
    def test_cross_file_optimization(self, real_optimizer):
        ...
        optimized, metrics = real_optimizer.optimize_for_llm(
            chunks, "gpt-4", 200, OptimizationStrategy.BALANCED
        )
...
class TestOptimizationEdgeCases:
    ...
    def test_circular_references(self, optimizer):
        ...
        optimized, metrics = optimizer.optimize_for_llm(
            [chunk1, chunk2], "gpt-4", 150, OptimizationStrategy.BALANCED
        )
