...
from chunker.query_advanced import (
    NaturalLanguageQueryEngine, AdvancedQueryIndex, SmartQueryOptimizer
)
from chunker.interfaces.query_advanced import QueryType, QueryResult
...
class TestNaturalLanguageQueryEngine:
    ...
    def test_natural_language_search(self, query_engine, sample_chunks):
        ...
        assert auth_intents_found or any("auth" in r.chunk.content.lower() for r in results[:2])
