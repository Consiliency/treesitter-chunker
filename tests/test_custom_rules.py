...
from chunker.rules.custom import (
    BaseCustomRule, BaseRegexRule, BaseCommentBlockRule, MetadataRule
)
from chunker.rules.builtin import (
    TodoCommentRule, CopyrightHeaderRule, DocstringRule,
    ImportBlockRule, CustomMarkerRule, SectionHeaderRule,
    ConfigurationBlockRule, LanguageSpecificCommentRule,
    DebugStatementRule, TestAnnotationRule, get_builtin_rules
)
...
class TestCopyrightHeaderRule:
    ...
    def test_copyright_patterns(self):
        ...
        test_cases = [
            ...
            b"/* License: MIT */",
            b"# (c) 2024 Author",
            "// © 2024 Company".encode('utf-8')  # Unicode copyright symbol
        ]
...
class TestBuiltinRules:
    ...
    def test_get_builtin_rules(self):
        ...
        expected_names = {
            'todo_comments', 'copyright_header', 'docstring',
...
class TestRuleComposition:
    ...
    def test_multiple_rule_types(self):
        ...
        from chunker.rules.comment import TodoBlockRule, HeaderCommentRule
...
"""
    ...
    def test_overlapping_rules(self):
        ...
        from chunker.rules.regex import RegionMarkerRule, PatternBoundaryRule
        
        engine = DefaultRuleEngine()
        
        # Add rules that might overlap
        engine.add_rule(RegionMarkerRule(priority=80))
        engine.add_rule(PatternBoundaryRule(
            "functions",
            r'def\s+\w+\s*\([^)]*\):',
            extract_match_only=True,
            priority=60
