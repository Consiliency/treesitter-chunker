...
from concurrent.futures import ProcessPoolExecutor, TimeoutError as FutureTimeoutError, ThreadPoolExecutor

from tests.integration.interfaces import ErrorPropagationMixin, ResourceTracker
from tests.integration.fixtures import (
    error_tracking_context, resource_monitor, 
    parallel_test_environment, mock_parser_factory,
    temp_workspace
)
...
class TestParallelErrorHandling(ErrorPropagationMixin):
    ...
    def test_worker_process_crash_recovery(self, error_tracking_context, 
    ...
    def test_resource_cleanup_after_errors(self, resource_monitor, 
                                         parallel_test_environment):
    ...
    def test_progress_tracking_with_failures(self, temp_workspace):
        ...
        failed_files = [
            u["filename"] for u in progress_updates 
            if u["status"] == "failed"
        ]
    ...
    def test_memory_leak_detection(self, resource_monitor, temp_workspace):
        ...
        for iteration in range(10):
            ...
            with ProcessPoolExecutor(max_workers=2) as executor:
                ...
                for test_file in test_files:
                    future = executor.submit(process_file_with_memory, (test_file, iteration))
                ...
                for i, future in enumerate(futures):
                    try:
                        ...
                        if iteration % 3 == 0:
                            ...
                            leaked_objects.append(f"iteration_{iteration}_file_{i}_error")
        ...
        assert memory_profile["leaked_objects"] == 0, f"Unexpected leaked objects detected: {memory_profile['leaked_objects']}"