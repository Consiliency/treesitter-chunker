...
class TestRealCompilation:
    ...
    def test_compile_single_grammar(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            if success:
                # Should have created a library file
    ...
    def test_compile_multiple_grammars(self):
    ...
    def test_build_wheel_with_grammars(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # If successful, verify the wheel
    ...
    def test_platform_specific_compilation(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Try compiling for current platform
            success, build_info = build_system.compile_grammars(
                languages=["python"],
                platform=current_os,
                output_dir=output_dir,
            ...
            # Compiler should match detected compiler
