...
class TestEnvironmentVariableOverrides:
    ...
    def test_override_language_config(self):
        ...
        os.environ['CHUNKER_LANGUAGES_PYTHON_CHUNK_TYPES'] = 'function_definition,class_definition'
    ...
    def test_override_custom_language_options(self):
        ...
        assert config.plugin_configs['python'].custom_options['include_docstrings'] == 'true'
        assert config.plugin_configs['javascript'].custom_options['include_jsx'] == 'false'
