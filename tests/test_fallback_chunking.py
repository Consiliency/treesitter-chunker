...
from chunker.fallback.detection.file_type import FileType, EncodingDetector
from chunker.interfaces.fallback import FallbackReason, ChunkingMethod, FallbackConfig
    ...
    def test_manager_file_detection(self):
        ...
        with tempfile.NamedTemporaryFile(mode='w', suffix='.log', delete=False) as f:
            ...
            with warnings.catch_warnings(record=True) as w:
                ...
                assert any(issubclass(warning.category, FallbackWarning) for warning in w)
