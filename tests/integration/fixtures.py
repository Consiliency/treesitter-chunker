...
def resource_monitor():
    ...
    def assert_no_leaks(module: Optional[str] = None):
        if module:
...
def test_file_generator(temp_workspace):
    ...
    class TestFileGenerator:
        ...
        def create_large_file(self, name: str, size_mb: int, 
                            pattern: str = "function", language: str = "python") -> Path:
...
"""
        ...
        def create_error_file(self, name: str, error_type: str, 
