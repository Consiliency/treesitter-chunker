...
class TreeSitterSemanticMerger(SemanticMerger):
    ...
    def _build_merge_groups(self, chunks: List[CodeChunk]) -> Dict[str, List[CodeChunk]]:
    ...
    def _are_small_related_methods(self, chunk1: CodeChunk, chunk2: CodeChunk) -> bool:
        ...
        if size1 > self.config.small_method_threshold or \
           size2 > self.config.small_method_threshold:
            return False
