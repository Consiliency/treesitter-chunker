...
class ParallelChunker:
    ...
    def __init__(self, language: str, num_workers: Optional[int] = None, 
                 use_cache: bool = True, use_streaming: bool = False):
    ...
    def chunk_files_parallel(self, file_paths: List[Path]) -> dict[Path, List[CodeChunk]]:
    ...
    def chunk_directory_parallel(self, directory: Path, 
                               extensions: Optional[List[str]] = None) -> dict[Path, List[CodeChunk]]:
...
def chunk_files_parallel(file_paths: List[str | Path], language: str, 
                        num_workers: Optional[int] = None,
                        use_cache: bool = True,
                        use_streaming: bool = False) -> dict[Path, List[CodeChunk]]:
...
def chunk_directory_parallel(directory: str | Path, language: str,
