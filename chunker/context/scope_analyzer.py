...
class BaseScopeAnalyzer(ScopeAnalyzer):
    ...
    def __init__(self, language: str):
        ...
        self._scope_cache: Dict[int, Optional[Node]] = {}
    ...
    def get_scope_type(self, scope_node: Node) -> str:
        ...
        if 'function' in node_type or 'method' in node_type:
            ...
            return 'class'
        elif 'module' in node_type or node_type == 'source_file':
            return 'module'
    ...
    def get_scope_chain(self, node: Node) -> List[Node]:
        ...
        # Start with the node itself if it's a scope
        if self._is_scope_node(node):
            scopes.append(node)
        
        # Walk up the tree collecting scopes
