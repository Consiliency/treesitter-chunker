...
class BaseSymbolResolver(SymbolResolver):
    ...
    def __init__(self, language: str):
        ...
        self._definition_cache: Dict[str, Optional[Node]] = {}
    ...
    def get_symbol_type(self, symbol_node: Node) -> str:
        ...
        if 'function' in parent_type or 'method' in parent_type:
            ...
            return 'class'
        elif 'variable' in parent_type or 'assignment' in parent_type:
            return 'variable'
    ...
    def _search_scope_for_definition(self, symbol_name: str, scope_node: Node) -> Optional[Node]:
    ...
    def _get_parent_scope(self, node: Node) -> Optional[Node]:
