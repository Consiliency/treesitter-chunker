...
from ..fallback.base import FallbackChunker, FallbackWarning
...
class OverlappingFallbackChunker(IOverlappingFallbackChunker):
    ...
    def _check_no_treesitter_support(self, file_path: str, language: Optional[str] = None):
    ...
    def _calculate_overlap(self, chunk_size: int, overlap_size: int, 
                          strategy: OverlapStrategy) -> int:
    ...
    def _chunk_by_lines_with_overlap(self, content: str, lines_per_chunk: int,
                                   overlap_lines: int) -> List[CodeChunk]:
    ...
    def _chunk_by_characters_with_overlap(self, content: str, chars_per_chunk: int,
                                        overlap_chars: int) -> List[CodeChunk]:
    ...
    def _chunk_by_characters_asymmetric(self, content: str, chars_per_chunk: int,
                                      overlap_before: int, overlap_after: int) -> List[CodeChunk]:
    ...
    def _chunk_by_characters_dynamic(self, content: str, chars_per_chunk: int,
                                   min_overlap: int, max_overlap: int) -> List[CodeChunk]:
