...
class ComplexityAnalyzer(ASTProcessor):
    ...
    def __init__(self):
        self.complexity_weights = {"if_statement": 1, "elif_clause": 1,
            "else_clause": 1, "while_statement": 1, "for_statement": 1,
            "for_in_statement": 1, "try_statement": 1, "except_clause": 1,
            "finally_clause": 1, "switch_statement": 1, "case_statement": 1,
            "conditional_expression": 1, "and": 1, "or": 1, "not": 0.5,
            "call": 0.5, "method_call": 0.5, "nested_if": 0.5,
            "nested_loop": 1.0, "nested_try": 0.5}

    def calculate_complexity(self, node: Node, _source: bytes) -> dict[str, Any,
        ]:
        """Calculate comprehensive complexity metrics for a node."""
        context = {"cyclomatic": 1, "cognitive": 0, "nesting_depth": 0,
            "max_nesting": 0, "dependencies": set(), "function_calls": 0,
            "branches": 0, "loops": 0, "exceptions": 0}
        self.traverse(node, context)
        complexity_score = context["cyclomatic"] * 1.0 + context["cognitive"
            ] * 0.5 + context["max_nesting"] * 0.3 + len(context[
            "dependencies"]) * 0.2
        return {"score": complexity_score, "cyclomatic": context[
            "cyclomatic"], "cognitive": context["cognitive"], "max_nesting":
            context["max_nesting"], "dependencies": list(context[
            "dependencies"]), "function_calls": context["function_calls"],
            "branches": context["branches"], "loops": context["loops"],
    ...
    def process_node(self, node: Node, context: dict[str, Any]) -> Any:
        ...
        if parent:
            ...
            if self._increases_nesting(node_type, parent_type):
                ...
                context["max_nesting"] = max(context["max_nesting"],
        ...
        if node_type in {"if_statement", "conditional_expression"}:
            ...
            parent_type = context.get("parent", {}).type if context.get(
                "parent") else None
    ...
    def _increases_nesting(node_type: str, _parent_type: str) -> bool:
        ...
        nesting_nodes = {"if_statement", "elif_clause", "else_clause",
    ...
    def get_complexity_threshold(node_type: str) -> float:
        ...
        thresholds = {"function_definition": 10.0, "method_definition":
            10.0, "class_definition": 50.0, "module": 100.0, "block": 5.0}
