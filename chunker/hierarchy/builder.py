...
from ..interfaces.hierarchy import ChunkHierarchyBuilder as ChunkHierarchyBuilderInterface
    ...
    def validate_hierarchy(self, hierarchy: ChunkHierarchy) -> bool:
        ...
        for child_id, parent_id in hierarchy.parent_map.items():
            ...
            if child_id not in hierarchy.children_map[parent_id]:
                raise ValueError(f"Child {child_id} not in parent {parent_id}'s children list")
