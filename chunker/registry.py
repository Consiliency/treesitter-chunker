...
from .exceptions import (
    LibraryNotFoundError, LibraryLoadError, LibrarySymbolError,
    LanguageNotFoundError, LanguageLoadError
)
    ...
    def discover_languages(self) -> Dict[str, LanguageMetadata]:
        ...
        for lang_name, symbol_name in symbols:
            try:
                ...
                logger.debug(f"Loaded language '{lang_name}' from symbol '{symbol_name}'")
