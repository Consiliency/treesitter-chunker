...
class BaseComplexityAnalyzer(ComplexityAnalyzer, ABC):
    ...
    def calculate_nesting_depth(self, node: Node) -> int:
        ...
        is_root_node = node.type in ('function_definition', 'method_definition', 'class_definition')
    ...
    def _find_operator_node(self, node: Node) -> Optional[Node]:
    ...
    def _increases_nesting(self, node_type: str) -> bool:
        ...
        return node_type in {
            ...
            'with_statement', 'match_statement', 'block_statement',
    ...
    def _is_comment_line(self, line: str) -> bool:
        ...
        return (
            ...
            line.startswith('/*') or
            line.startswith('*/') or
            line.startswith('"' * 3) or  # Python docstring
            line.startswith("'" * 3)      # Python docstring
        )