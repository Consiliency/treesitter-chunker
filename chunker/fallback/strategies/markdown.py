...
from ...interfaces.fallback import ChunkingMethod, FallbackConfig, MarkdownChunker as IMarkdownChunker
...
class MarkdownChunker(FallbackChunker, IMarkdownChunker):
    ...
    def chunk_by_headers(self,
        ...
        headers: List[Tuple[int, int, str, str]] = []  # (line_num, level, text, full_line)
        ...
        for i, line in enumerate(lines):
            ...
            if line_stripped.startswith('```'):
                if not in_code_block:
                    ...
                    code_block_lang = match.group(1) if match and match.group(1) else "unknown"
