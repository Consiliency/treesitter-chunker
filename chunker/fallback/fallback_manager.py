...
from .detection.file_type import FileTypeDetector, FileType, EncodingDetector
...
class FallbackManager:
    ...
    def chunk_file(self,
                  file_path: str,
                  reason: Optional[FallbackReason] = None) -> List[CodeChunk]:
        ...
        logger.info(f"Created {len(chunks)} chunks for {file_path} using {file_type.value} strategy")
