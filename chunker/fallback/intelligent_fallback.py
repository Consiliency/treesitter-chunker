...
from ..interfaces.fallback import FallbackReason, FallbackConfig
...
class IntelligentFallbackChunker(FallbackChunker):
    ...
    def _detect_language(self, file_path: str, content: str) -> Optional[str]:
        ...
        if content.startswith('#!'):
            ...
            if 'python' in first_line:
                ...
                return 'javascript' if 'javascript' in self._supported_languages else None
    ...
    def _analyze_content(self, 
                        content: str, 
                        file_path: str,
                        language: Optional[str]) -> DecisionMetrics:
        ...
        if language and language in self._supported_languages:
            ...
            try:
                ...
                # Analyze chunk sizes
                    ...
                    if self.token_limit and metrics.largest_chunk_tokens > self.token_limit:
    ...
    def _make_decision(self, metrics: DecisionMetrics) -> Tuple[ChunkingDecision, str]:
        ...
        if metrics.has_specialized_processor:
            reasons.append(f"specialized processor available: {metrics.specialized_processor_name}")
    ...
    def chunk_text(self, 
        ...
        elif decision in [ChunkingDecision.SLIDING_WINDOW, ChunkingDecision.SPECIALIZED_PROCESSOR]:
