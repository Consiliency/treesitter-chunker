...
class DebugREPL:
    ...
    def __init__(self):
        ...
        self.query_debugger: Optional[QueryDebugger] = None
        self.chunk_debugger: Optional[ChunkDebugger] = None
        self.node_explorer: Optional[NodeExplorer] = None
        self.history: list = []
...
"""
    ...
    def _save_session(self, file_path: str) -> None:
        ...
        try:
            with open(file_path, 'w') as f:
                f.write(f"# Tree-sitter Debug Session\n")
    ...
    def _show_info(self) -> None:
        ...
        info = {
            ...
            "Code Size": f"{len(self.current_code)} bytes" if self.current_code else "No code",
    ...
    def _check_ready(self) -> bool:
        ...
        if not self.current_language:
            self.console.print("[red]Please set a language first (lang <language>)[/red]")
            return False
