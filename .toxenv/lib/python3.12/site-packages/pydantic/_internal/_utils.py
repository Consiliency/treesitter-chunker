...
from typing import Any, Generic, TypeAlias, TypeGuard, TypeVar, overload
...
class ValueItems(_repr.Representation):
    ...
    def _normalize_indexes(
        ...
        for i, v in items.items():
            if not (isinstance(v, typing.AbstractSet | typing.Mapping)):
                raise TypeError(
            ...
            normalized_items[normalized_i] = self.merge(
                v,
                normalized_items.get(normalized_i),
            )
