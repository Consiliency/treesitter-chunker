...
DecoratorInfo: TypeAlias = (
    """ValidatorDecoratorInfo | FieldValidatorDecoratorInfo | RootValidatorDecoratorInfo | FieldSerializerDecoratorInfo | ModelSerializerDecoratorInfo | ModelValidatorDecoratorInfo | ComputedFieldInfo"""
)
...
class PydanticDescriptorProxy(Generic[ReturnType]):
    ...
    def __get__(
        self,
        obj: object | None,
        obj_type: type[object] | None = None,
    ) -> PydanticDescriptorProxy[ReturnType]:
        try:
