...
if PYDANTIC_V2:
    ...
    from pydantic.class_validators import (
        Validator as Validator,  # type: ignore[no-redef]
    )
    from pydantic.error_wrappers import (
        ErrorWrapper as ErrorWrapper,  # type: ignore[no-redef]
    )
    ...
    from pydantic.fields import (
        ModelField as ModelField,  # type: ignore[no-redef,attr-defined]
    )
    ...
    from pydantic.fields import (
        UndefinedType as UndefinedType,  # type: ignore[no-redef, attr-defined]
    )
    from pydantic.schema import field_schema
    from pydantic.schema import (
        get_annotation_from_field_info as get_annotation_from_field_info,  # type: ignore[no-redef]
    )
    from pydantic.schema import (
    ...
    from pydantic.utils import (
        lenient_issubclass as lenient_issubclass,  # type: ignore[no-redef]
    )
