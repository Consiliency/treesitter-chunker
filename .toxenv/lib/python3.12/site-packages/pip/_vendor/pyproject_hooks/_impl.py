...
def norm_and_check(source_tree: str, requested: str) -> str:
    ...
    abs_source = pathlib.Path(source_tree).resolve()
...
class BuildBackendHookCaller:
    ...
    def prepare_metadata_for_build_wheel(
        ...
        return self._call_hook(
            ...
            {
                "metadata_directory": pathlib.Path(metadata_directory).resolve(),
                "config_settings": config_settings,
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            with _in_proc_script_path() as script:
                ...
                self._subprocess_runner(
                    [python, pathlib.Path(str(script)).resolve(), hook_name, td],
                    cwd=self.source_dir,
