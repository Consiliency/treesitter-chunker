...
def _find_already_built_wheel(metadata_directory):
    ...
    if not metadata_directory:
        return None
    metadata_parent = pathlib.Path(metadata_directory).parent
    if not pathlib.Path(pjoin(metadata_parent, WHEEL_BUILT_MARKER)).is_file():
        return None
...
def build_wheel(wheel_directory, config_settings, metadata_directory=None):
    ...
    if prebuilt_whl:
        ...
        return pathlib.Path(prebuilt_whl).name
