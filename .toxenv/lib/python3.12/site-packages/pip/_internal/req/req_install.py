...
class InstallRequirement:
    ...
    def __init__(
        ...
        *,
        ...
        if self.editable:
            assert link
            if link.is_file:
                self.source_dir = os.path.normpath(Path(link.file_path).resolve())
    ...
    def isolated_editable_sanity_check(self) -> None:
        ...
        if (
            ...
            and not Path(self.setup_py_path).is_file()
            and not Path(self.setup_cfg_path).is_file()
        ):
            raise InstallationError(
    ...
    def archive(self, build_dir: str | None) -> None:
        ...
        with zip_output:
            dir = os.path.normcase(Path(self.unpacked_source_directory).resolve())
