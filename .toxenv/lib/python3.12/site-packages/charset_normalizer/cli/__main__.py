...
def cli_detect(argv: list[str] | None = None) -> int:
    ...
    for my_file in args.files:
        ...
        if best_guess is None:
            ...
            x_.append(
                CliDetectionResult(
                    pathlib.Path(my_file.name).resolve(),
                    None,
                    [],
                    [],
                    "Unknown",
            ...
            if args.normalize is True:
                ...
                dir_path = pathlib.Path(realpath(my_file.name)).parent
                file_name = pathlib.Path(realpath(my_file.name)).name
            ...
            print(
                ", ".join(
                    [
                        ...
                        for el in x_
                        if el.path == pathlib.Path(my_file.name).resolve()
                    ],
                ),
            )
