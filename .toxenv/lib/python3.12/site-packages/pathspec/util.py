...
from typing import AnyStr  # Replaced by `collections.abc.Collection` in 3.9.
from typing import Dict  # Replaced by `dict` in 3.9.
from typing import Generic  # Replaced by `collections.abc.Iterator` in 3.9.
from typing import List  # Replaced by `list` in 3.9.
from typing import Optional  # Replaced by `collections.abc.Sequence` in 3.9.
...
def iter_tree_entries(
    ...
    *follow_links* (:class:`bool` or :data:`None`) optionally is whether
    ...
    yield from _iter_tree_entries_next(
        pathlib.Path(root).resolve(), "", {}, on_error, follow_links
    )
