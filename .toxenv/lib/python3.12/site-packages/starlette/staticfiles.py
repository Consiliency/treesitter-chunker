...
class StaticFiles:
    def __init__(
        ...
        *,
        ...
        if check_dir and directory is not None and not pathlib.Path(directory).is_dir():
    ...
    def get_directories(
        ...
        for package in packages or []:
            ...
            assert pathlib.Path(
                package_directory,
            ).is_dir(), f"Directory '{statics_dir!r}' in package {package!r} could not be found."
    ...
    def lookup_path(self, path: str) -> tuple[str, os.stat_result | None]:
        for directory in self.all_directories:
            ...
            if self.follow_symlink:
                full_path = pathlib.Path(joined_path).resolve()
