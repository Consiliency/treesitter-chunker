...
class TestUtils(TestBase):
    ...
    def test_lockedfd(self):
        ...
        try:
            ...
            # open for writing
            assert not pathlib.Path(lockfilepath).is_file()
            wfd = lfd.open(write=True)
            assert lfd._fd is wfd
            assert pathlib.Path(lockfilepath).is_file()
        ...
        try:
            ...
            assert not pathlib.Path(lfd._lockfilepath()).exists()
        else:
