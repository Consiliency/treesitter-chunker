...
class TagObject(base.Object):
    ...
    def __init__(
        ...
        repo: "Repo",
        binsha: bytes,
        object: None | base.Object = None,
        tag: None | str = None,
        tagger: None | Actor = None,
        tagged_date: int | None = None,
        tagger_tz_offset: int | None = None,
        ...
        if object is not None:
            self.object: Commit | Blob | Tree | TagObject = object
        if tag is not None:
            self.tag = tag
