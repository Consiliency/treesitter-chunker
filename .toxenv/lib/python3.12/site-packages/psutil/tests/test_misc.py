...
class TestMisc(PsutilTestCase):
    ...
    def test_ad_on_process_creation(self):
        ...
        with mock.patch.object(
            psutil.Process,
            "_get_ident",
            side_effect=psutil.ZombieProcess(1),
        ) as meth:
            psutil.Process()
            assert meth.called
    ...
    def test_sanity_version_check(self):
        ...
        with mock.patch(
            "psutil._psplatform.cext.version",
            return_value="0.0.0",
        ):
