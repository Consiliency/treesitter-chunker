...
from benchmarks.benchmark import run_benchmarks, BenchmarkSuite
...
def main():
    parser = argparse.ArgumentParser(description="Run treesitter-chunker performance benchmarks")
