...
def test_decimals(gdb_arrow):
    ...
    check_stack_repr(
        gdb_arrow,
        "basic_decimal128_pos",
        f"arrow::BasicDecimal128({v128})",
    )
    check_stack_repr(
        gdb_arrow,
        "basic_decimal128_neg",
        f"arrow::BasicDecimal128(-{v128})",
    )
    ...
    check_stack_repr(
        gdb_arrow,
        "basic_decimal256_pos",
        f"arrow::BasicDecimal256({v256})",
    )
    check_stack_repr(
        gdb_arrow,
        "basic_decimal256_neg",
        f"arrow::BasicDecimal256(-{v256})",
    )
...
def test_datum(gdb_arrow):
    ...
    check_stack_repr(
        ...
        "batch_datum",
        re.compile(
            r"^arrow::Datum of value arrow::RecordBatch with 2 columns, 3 rows ",
        ),
    )
    check_stack_repr(
        gdb_arrow,
        "table_datum",
        re.compile(r"^arrow::Datum of value arrow::Table with 2 columns, 5 rows "),
    )
