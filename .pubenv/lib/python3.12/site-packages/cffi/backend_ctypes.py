...
class CTypesBackend:
    ...
    def complete_struct_or_union(
        ...
        def initialize(blob, init):
            ...
            if not isinstance(init, dict):
                ...
                init = dict(zip(fnames, init, strict=False))
        ...
        name2fieldtype = dict(zip(fnames, zip(btypes, bitfields, strict=False), strict=False))
        for fname, BField, bitsize in fields:
            if fname == "":
    ...
    def new_function_type(self, BArgs, BResult, has_varargs):
        ...
        class CTypesFunctionPtr(CTypesGenericPtr):
            ...
            def __init__(self, init, error=None):
                ...
                def callback(*args):
                    args2 = []
                    for arg, BArg in zip(args, BArgs, strict=False):
    ...
    def new_enum_type(self, name, enumerators, enumvalues, CTypesInt):
        ...
        reverse_mapping = dict(zip(reversed(enumvalues), reversed(enumerators), strict=False))
