...
class StructOrUnion(StructOrUnionOrEnum):
    ...
    def anonymous_struct_fields(self):
        if self.fldtypes is not None:
            for name, type in zip(self.fldnames, self.fldtypes, strict=False):
    ...
    def enumfields(self, expand_anonymous_struct_union=True):
        ...
        for name, type, bitsize, quals in zip(
            self.fldnames, self.fldtypes, self.fldbitsize, fldquals, strict=False,
        ):
            if (
                name == ""
    ...
    def finish_backend_type(self, ffi, finishlist):
        ...
        if self.fldtypes is None:
            ...
            lst = list(zip(self.fldnames, fldtypes, self.fldbitsize, strict=False))
            extra_flags = ()
            if self.packed:
                if self.packed == 1:
            ...
            lst = list(zip(self.fldnames, fldtypes, self.fldbitsize, fieldofs, strict=False))
            ffi._backend.complete_struct_or_union(
