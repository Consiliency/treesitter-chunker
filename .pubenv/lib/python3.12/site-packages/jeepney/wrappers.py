...
class DBusAddress:
    ...
    def __repr__(self):
        return f"{type(self).__name__}({self.object_path!r}, bus_name={self.bus_name!r}, interface={self.interface!r})"
...
class MessageGenerator:
    ...
    def __repr__(self):
        return f"{type(self).__name__}({self.object_path!r}, bus_name={self.bus_name!r})"
...
class Properties:
    ...
    def __init__(self, obj: DBusAddress | MessageGenerator):
        self.obj = obj
