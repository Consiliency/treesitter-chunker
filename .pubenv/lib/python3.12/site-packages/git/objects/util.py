...
def get_object_type_by_name(
    ...
    if object_type_name == b"tag":
        from . import tag

        return tag.TagObject
    if object_type_name == b"blob":
        from . import blob

        return blob.Blob
    if object_type_name == b"tree":
        from . import tree
    ...
    * :class:`Submodule <git.objects.submodule.base.Submodule>`
    ...
    def _list_traverse(
        ...
        **kwargs: Any,
        ...
        if not as_edge:
            out: IterableList["Commit" | "Submodule" | "Tree" | "Blob"] = IterableList(
                id,
            )
    ...
    def _traverse(
        self,
        predicate: Callable[
            [Union["Traversable", "Blob", TraversedTup], int],
            bool,
        ] = lambda i, d: True,
        prune: Callable[
            [Union["Traversable", "Blob", TraversedTup], int],
        ...
        while stack:
            ...
            rval: TraversedTup | "Traversable" | "Blob"
            if as_edge:
...
class TraversableIterableObj(IterableObj, Traversable):
    ...
    def traverse(
        self: T_TIobj,
        predicate: Callable[
            [T_TIobj | tuple[T_TIobj | None, T_TIobj], int],
            bool,
        ],
        prune: Callable[
            [T_TIobj | tuple[T_TIobj | None, T_TIobj], int],
    ...
    def traverse(
        ...
        return cast(
            Iterator[T_TIobj] | Iterator[tuple[None | T_TIobj, T_TIobj]],
            super()._traverse(
