...
class CeylonLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                r"(abstracts|extends|satisfies|super|given|of|out|assign)\b",
                Keyword.Declaration,
            ),
...
class KotlinLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            # Numbers
            (
                r"[0-9](\.[0-9]*)?([eE][+-][0-9]+)?[flFL]?|0[xX][0-9a-fA-F]+[Ll]?",
                Number,
            ),
            # Identifiers
...
class GoloLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                r"(print|println|readln|raise|fun|asInterfaceInstance)\b",
                Name.Builtin,
            ),
