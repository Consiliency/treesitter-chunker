    ...
    while len(string) > 0:
        ...
        if c == "\\":  # start of a LaTeX macro
            ...
            if c == "-" and len(node):
                ...
                if (
                    previous_node.text and previous_node.text in "([="
...
def handle_cmd(name, node, string):  # TODO make this less complex
...
def handle_script_or_limit(node, c, limits=""):
    ...
    if c == "_":
        ...
        elif limits in ("limits", "movablelimits") or (
            limits == "" and child.get("movablelimits", None)
        ):
