...
class ReadMeHTMLTranslator(HTMLTranslator):  # type: ignore[misc] # docutils is incomplete, returns `Any` python/typeshed#7256 # E501
...
def render(raw: str, stream: IO[str] | None = None, **kwargs: Any) -> str | None:
    if stream is None:
